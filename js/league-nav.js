...
(function(){
  "use strict";
  const LEAGUES = [
    {file:"england.html", name:"英超",   sub:"Premier League", flag:"eng", c1:"#3d195b"},
    {file:"spain.html",   name:"西甲",   sub:"LaLiga",         flag:"esp", c1:"#ff6a13"},
    {file:"italy.html",   name:"意甲",   sub:"Serie A",        flag:"ita", c1:"#008fd7"},
    {file:"germany.html", name:"德甲",   sub:"Bundesliga",     flag:"ger", c1:"#d20515"},
    {file:"france.html",  name:"法甲",   sub:"Ligue 1",        flag:"fra", c1:"#091c3e"}
  ];
  const EXTRA = {file:"worldcup.html", name:"世界杯", sub:"World Cup", flag:"world", c1:"#0b5d2e"};
  ...
  const extra = `<a class="lg-item lg-extra ${EXTRA.file===cur?'active':''}" href="${EXTRA.file}" style="--lg-c:${EXTRA.c1}">
      <span class="lg-flag lg-flag-${EXTRA.flag}"></span>
      <span class="lg-txt">
